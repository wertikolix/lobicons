...
private var _flowith: ImageVector? = null

val Lobicons.Flowith: ImageVector
    get() {
        if (_flowith != null) return _flowith!!
        _flowith = ImageVector.Builder(
            name = "Flowith",
