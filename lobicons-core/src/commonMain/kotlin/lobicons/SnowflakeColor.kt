...
private var _snowflakecolor: ImageVector? = null

val Lobicons.SnowflakeColor: ImageVector
    get() {
        if (_snowflakecolor != null) return _snowflakecolor!!
        _snowflakecolor = ImageVector.Builder(
            name = "SnowflakeColor",
