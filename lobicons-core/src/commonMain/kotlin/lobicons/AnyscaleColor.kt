...
private var _anyscalecolor: ImageVector? = null

val Lobicons.AnyscaleColor: ImageVector
    get() {
        if (_anyscalecolor != null) return _anyscalecolor!!
        _anyscalecolor = ImageVector.Builder(
            name = "AnyscaleColor",
            ...
            path(fill = SolidColor(Color(0xFF0163FB))) {
