...
private var _cybercut: ImageVector? = null

val Lobicons.Cybercut: ImageVector
    get() {
        if (_cybercut != null) return _cybercut!!
        _cybercut = ImageVector.Builder(
            name = "Cybercut",
