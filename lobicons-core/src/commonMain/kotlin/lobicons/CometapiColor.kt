...
private var _cometapicolor: ImageVector? = null

val Lobicons.CometapiColor: ImageVector
    get() {
        if (_cometapicolor != null) return _cometapicolor!!
        _cometapicolor = ImageVector.Builder(
            name = "CometapiColor",
