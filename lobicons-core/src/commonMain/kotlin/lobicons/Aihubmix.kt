...
private var _aihubmix: ImageVector? = null

val Lobicons.Aihubmix: ImageVector
    get() {
        if (_aihubmix != null) return _aihubmix!!
        _aihubmix = ImageVector.Builder(
            name = "Aihubmix",
