...
private var _sambanovacolor: ImageVector? = null

val Lobicons.SambanovaColor: ImageVector
    get() {
        if (_sambanovacolor != null) return _sambanovacolor!!
        _sambanovacolor = ImageVector.Builder(
            name = "SambanovaColor",
