...
private var _llmapicolor: ImageVector? = null

val Lobicons.LlmapiColor: ImageVector
    get() {
        if (_llmapicolor != null) return _llmapicolor!!
        _llmapicolor = ImageVector.Builder(
            name = "LlmapiColor",
            ...
            path(fill = SolidColor(Color(0xFFFFFFFF))) {
                pathData("M11.938 20.811l-.15.087-4.096 2.36-.449.26v-6.756l.15-.086 4.095-2.36.45-.26v6.755zM21.576 20.811l-.15.087-4.096 2.36-.45.26v-6.756l.151-.086 4.096-2.36.45-.26v6.755z")
            }
            path(fill = SolidColor(Color(0xFFFFFFFF))) {
                pathData("M17.146 11.432l4.357 2.51-4.535 2.615-.15.087-.15-.087L12 13.863l-.677.392-3.992 2.302-.15.087-.149-.087-4.534-2.615 4.191-2.416.21-.12.162.178a6.506 6.506 0 004.144 2.112l.769.08.77-.103a6.517 6.517 0 004.028-2.179l.163-.185.212.123zM21.576 13.83l-.449-.26-4.173-2.404 4.173-2.404.45-.26v5.328z")
            }
            path(fill = SolidColor(Color(0xFFFFFFFF)), pathFillType = PathFillType.EvenOdd) {
                pathData("M12.207.447c3.412.177 6.116 3.055 6.116 6.569l-.008.338c-.166 3.358-2.806 6.06-6.108 6.23l-.332.009c-3.455 0-6.267-2.77-6.44-6.24l-.007-.337c0-3.627 2.88-6.577 6.447-6.578l.332.01z")
            }
            path(fill = SolidColor(Color(0xFFFFFFFF))) {
                pathData("M21.503 8.389l-4.081 2.351.396-.857c.386-.834.61-1.762.627-2.742l.01-.51 3.048 1.758zM5.31 7.275c.032.86.222 1.677.54 2.423l.353.827L2.497 8.39 4.86 7.026l.431-.249.019.498z")
            }
