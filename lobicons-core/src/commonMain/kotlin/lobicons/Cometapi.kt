...
private var _cometapi: ImageVector? = null

val Lobicons.Cometapi: ImageVector
    get() {
        if (_cometapi != null) return _cometapi!!
        _cometapi = ImageVector.Builder(
            name = "Cometapi",
