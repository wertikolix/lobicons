...
private var _sensenovacolor: ImageVector? = null

val Lobicons.SensenovaColor: ImageVector
    get() {
        if (_sensenovacolor != null) return _sensenovacolor!!
        _sensenovacolor = ImageVector.Builder(
            name = "SensenovaColor",
