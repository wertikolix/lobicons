...
private var _aihubmixcolor: ImageVector? = null

val Lobicons.AihubmixColor: ImageVector
    get() {
        if (_aihubmixcolor != null) return _aihubmixcolor!!
        _aihubmixcolor = ImageVector.Builder(
            name = "AihubmixColor",
