...
private var _llamaindexcolor: ImageVector? = null

val Lobicons.LlamaindexColor: ImageVector
    get() {
        if (_llamaindexcolor != null) return _llamaindexcolor!!
        _llamaindexcolor = ImageVector.Builder(
