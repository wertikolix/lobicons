...
private var _alephalpha: ImageVector? = null

val Lobicons.Alephalpha: ImageVector
    get() {
        if (_alephalpha != null) return _alephalpha!!
        _alephalpha = ImageVector.Builder(
            name = "Alephalpha",
