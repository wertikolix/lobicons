...
private var _newapicolor: ImageVector? = null

val Lobicons.NewapiColor: ImageVector
    get() {
        if (_newapicolor != null) return _newapicolor!!
        _newapicolor = ImageVector.Builder(
            name = "NewapiColor",
