...
private var _voyagecolor: ImageVector? = null

val Lobicons.VoyageColor: ImageVector
    get() {
        if (_voyagecolor != null) return _voyagecolor!!
        _voyagecolor = ImageVector.Builder(
            name = "VoyageColor",
            ...
            path(fill = SolidColor(Color(0xFF012E33))) {
