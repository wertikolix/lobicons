...
private var _tripocolor: ImageVector? = null

val Lobicons.TripoColor: ImageVector
    get() {
        if (_tripocolor != null) return _tripocolor!!
        _tripocolor = ImageVector.Builder(
            name = "TripoColor",
            ...
            path(fill = SolidColor(Color(0xFFF6D85A)), pathFillType = PathFillType.EvenOdd) {
