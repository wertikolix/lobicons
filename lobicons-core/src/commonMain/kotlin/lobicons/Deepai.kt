...
private var _deepai: ImageVector? = null

val Lobicons.Deepai: ImageVector
    get() {
        if (_deepai != null) return _deepai!!
        _deepai = ImageVector.Builder(
            name = "Deepai",
