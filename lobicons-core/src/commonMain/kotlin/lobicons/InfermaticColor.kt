...
private var _infermaticcolor: ImageVector? = null

val Lobicons.InfermaticColor: ImageVector
    get() {
        if (_infermaticcolor != null) return _infermaticcolor!!
        _infermaticcolor = ImageVector.Builder(
