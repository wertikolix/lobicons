...
private var _submodelcolor: ImageVector? = null

val Lobicons.SubmodelColor: ImageVector
    get() {
        if (_submodelcolor != null) return _submodelcolor!!
        _submodelcolor = ImageVector.Builder(
            name = "SubmodelColor",
