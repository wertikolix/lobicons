...
private var _antgroup: ImageVector? = null

val Lobicons.Antgroup: ImageVector
    get() {
        if (_antgroup != null) return _antgroup!!
        _antgroup = ImageVector.Builder(
            name = "Antgroup",
