...
private var _searchapi: ImageVector? = null

val Lobicons.Searchapi: ImageVector
    get() {
        if (_searchapi != null) return _searchapi!!
        _searchapi = ImageVector.Builder(
            name = "Searchapi",
