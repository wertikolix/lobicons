...
private var _ai2color: ImageVector? = null

val Lobicons.Ai2Color: ImageVector
    get() {
        if (_ai2color != null) return _ai2color!!
        _ai2color = ImageVector.Builder(
            name = "Ai2Color",
            ...
            path(fill = SolidColor(Color(0xFFF0529C))) {
