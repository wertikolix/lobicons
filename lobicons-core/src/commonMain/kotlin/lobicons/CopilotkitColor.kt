...
private var _copilotkitcolor: ImageVector? = null

val Lobicons.CopilotkitColor: ImageVector
    get() {
        if (_copilotkitcolor != null) return _copilotkitcolor!!
        _copilotkitcolor = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFF513C9F))) {
                pathData("M12.725.075c.046-.019.1.003.119.05l7.514 17.923a.091.091 0 01-.148.1l-.02-.03L12.675.195a.091.091 0 01.049-.12z")
            }
            path(fill = SolidColor(Color(0xFF513C9F))) {
                pathData("M23.06 2.66c.044-.025.1-.01.125.034.025.044.009.1-.035.124v.001l-.008.004-.025.015-.1.054a41.384 41.384 0 01-1.811.92A47.05 47.05 0 0116.33 5.82c-1.954.674-3.97 1.197-5.497 1.552a66.27 66.27 0 01-2.38.507l-.138.026-.036.007h-.01l-.002.002a.091.091 0 11-.033-.18l.016.09-.015-.09h.002l.01-.002.035-.007.137-.025a66.16 66.16 0 002.373-.506c1.524-.354 3.533-.876 5.479-1.547a46.857 46.857 0 006.276-2.709c.166-.087.295-.156.381-.204l.099-.054.024-.014.008-.004z")
            }
