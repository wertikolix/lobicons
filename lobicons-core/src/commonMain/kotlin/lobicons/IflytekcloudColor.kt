...
private var _iflytekcloudcolor: ImageVector? = null

val Lobicons.IflytekcloudColor: ImageVector
    get() {
        if (_iflytekcloudcolor != null) return _iflytekcloudcolor!!
        _iflytekcloudcolor = ImageVector.Builder(
