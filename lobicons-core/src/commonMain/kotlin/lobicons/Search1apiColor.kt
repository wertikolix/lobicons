...
private var _search1apicolor: ImageVector? = null

val Lobicons.Search1apiColor: ImageVector
    get() {
        if (_search1apicolor != null) return _search1apicolor!!
        _search1apicolor = ImageVector.Builder(
