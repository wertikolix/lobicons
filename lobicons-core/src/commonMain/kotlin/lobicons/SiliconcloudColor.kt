...
private var _siliconcloudcolor: ImageVector? = null

val Lobicons.SiliconcloudColor: ImageVector
    get() {
        if (_siliconcloudcolor != null) return _siliconcloudcolor!!
        _siliconcloudcolor = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFF6E29F6)), pathFillType = PathFillType.EvenOdd) {
