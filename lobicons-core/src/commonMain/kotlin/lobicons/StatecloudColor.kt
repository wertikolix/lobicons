...
private var _statecloudcolor: ImageVector? = null

val Lobicons.StatecloudColor: ImageVector
    get() {
        if (_statecloudcolor != null) return _statecloudcolor!!
        _statecloudcolor = ImageVector.Builder(
