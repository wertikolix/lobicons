...
private var _friendli: ImageVector? = null

val Lobicons.Friendli: ImageVector
    get() {
        if (_friendli != null) return _friendli!!
        _friendli = ImageVector.Builder(
            name = "Friendli",
