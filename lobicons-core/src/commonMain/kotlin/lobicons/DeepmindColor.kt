...
private var _deepmindcolor: ImageVector? = null

val Lobicons.DeepmindColor: ImageVector
    get() {
        if (_deepmindcolor != null) return _deepmindcolor!!
        _deepmindcolor = ImageVector.Builder(
            name = "DeepmindColor",
