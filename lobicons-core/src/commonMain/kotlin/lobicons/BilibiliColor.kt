...
private var _bilibilicolor: ImageVector? = null

val Lobicons.BilibiliColor: ImageVector
    get() {
        if (_bilibilicolor != null) return _bilibilicolor!!
        _bilibilicolor = ImageVector.Builder(
            name = "BilibiliColor",
