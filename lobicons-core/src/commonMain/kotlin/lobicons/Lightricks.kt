...
private var _lightricks: ImageVector? = null

val Lobicons.Lightricks: ImageVector
    get() {
        if (_lightricks != null) return _lightricks!!
        _lightricks = ImageVector.Builder(
            name = "Lightricks",
