...
private var _haiper: ImageVector? = null

val Lobicons.Haiper: ImageVector
    get() {
        if (_haiper != null) return _haiper!!
        _haiper = ImageVector.Builder(
            name = "Haiper",
