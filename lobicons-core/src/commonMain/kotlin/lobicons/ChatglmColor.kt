...
private var _chatglmcolor: ImageVector? = null

val Lobicons.ChatglmColor: ImageVector
    get() {
        if (_chatglmcolor != null) return _chatglmcolor!!
        _chatglmcolor = ImageVector.Builder(
            name = "ChatglmColor",
