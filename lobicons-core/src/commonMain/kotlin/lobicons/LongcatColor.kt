...
private var _longcatcolor: ImageVector? = null

val Lobicons.LongcatColor: ImageVector
    get() {
        if (_longcatcolor != null) return _longcatcolor!!
        _longcatcolor = ImageVector.Builder(
            name = "LongcatColor",
