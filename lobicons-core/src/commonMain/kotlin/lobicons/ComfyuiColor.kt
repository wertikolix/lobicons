...
private var _comfyuicolor: ImageVector? = null

val Lobicons.ComfyuiColor: ImageVector
    get() {
        if (_comfyuicolor != null) return _comfyuicolor!!
        _comfyuicolor = ImageVector.Builder(
            name = "ComfyuiColor",
