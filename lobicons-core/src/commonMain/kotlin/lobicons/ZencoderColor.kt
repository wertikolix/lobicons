...
private var _zencodercolor: ImageVector? = null

val Lobicons.ZencoderColor: ImageVector
    get() {
        if (_zencodercolor != null) return _zencodercolor!!
        _zencodercolor = ImageVector.Builder(
            name = "ZencoderColor",
