...
private var _smithery: ImageVector? = null

val Lobicons.Smithery: ImageVector
    get() {
        if (_smithery != null) return _smithery!!
        _smithery = ImageVector.Builder(
            name = "Smithery",
