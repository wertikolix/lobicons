...
private var _nanobanana: ImageVector? = null

val Lobicons.Nanobanana: ImageVector
    get() {
        if (_nanobanana != null) return _nanobanana!!
        _nanobanana = ImageVector.Builder(
            name = "Nanobanana",
