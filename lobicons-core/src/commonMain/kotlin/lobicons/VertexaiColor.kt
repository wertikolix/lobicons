...
private var _vertexaicolor: ImageVector? = null

val Lobicons.VertexaiColor: ImageVector
    get() {
        if (_vertexaicolor != null) return _vertexaicolor!!
        _vertexaicolor = ImageVector.Builder(
            name = "VertexaiColor",
            ...
            path(fill = SolidColor(Color(0xFF669DF6)), pathFillType = PathFillType.EvenOdd) {
            ...
            path(fill = SolidColor(Color(0xFFAECBFA)), pathFillType = PathFillType.EvenOdd) {
            ...
            path(fill = SolidColor(Color(0xFFAECBFA))) {
            ...
            path(fill = SolidColor(Color(0xFF669DF6))) {
