...
private var _cherrystudio: ImageVector? = null

val Lobicons.Cherrystudio: ImageVector
    get() {
        if (_cherrystudio != null) return _cherrystudio!!
        _cherrystudio = ImageVector.Builder(
            name = "Cherrystudio",
