...
private var _rsshubcolor: ImageVector? = null

val Lobicons.RsshubColor: ImageVector
    get() {
        if (_rsshubcolor != null) return _rsshubcolor!!
        _rsshubcolor = ImageVector.Builder(
            name = "RsshubColor",
            ...
            path(fill = SolidColor(Color(0xFFFFD6A6))) {
            ...
            path(fill = SolidColor(Color(0xFFFF8549))) {
            ...
            path(fill = SolidColor(Color(0xFFFF2900))) {
