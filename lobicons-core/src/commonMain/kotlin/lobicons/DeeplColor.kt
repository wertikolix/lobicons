...
private var _deeplcolor: ImageVector? = null

val Lobicons.DeeplColor: ImageVector
    get() {
        if (_deeplcolor != null) return _deeplcolor!!
        _deeplcolor = ImageVector.Builder(
            name = "DeeplColor",
