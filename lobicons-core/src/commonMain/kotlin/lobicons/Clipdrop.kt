...
private var _clipdrop: ImageVector? = null

val Lobicons.Clipdrop: ImageVector
    get() {
        if (_clipdrop != null) return _clipdrop!!
        _clipdrop = ImageVector.Builder(
            name = "Clipdrop",
