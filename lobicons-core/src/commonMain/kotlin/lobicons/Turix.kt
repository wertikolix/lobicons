...
private var _turix: ImageVector? = null

val Lobicons.Turix: ImageVector
    get() {
        if (_turix != null) return _turix!!
        _turix = ImageVector.Builder(
            name = "Turix",
