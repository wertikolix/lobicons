...
private var _difycolor: ImageVector? = null

val Lobicons.DifyColor: ImageVector
    get() {
        if (_difycolor != null) return _difycolor!!
        _difycolor = ImageVector.Builder(
            name = "DifyColor",
            ...
            path(fill = SolidColor(Color(0xFF0033FF))) {
