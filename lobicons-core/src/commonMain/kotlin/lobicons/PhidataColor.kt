...
private var _phidatacolor: ImageVector? = null

val Lobicons.PhidataColor: ImageVector
    get() {
        if (_phidatacolor != null) return _phidatacolor!!
        _phidatacolor = ImageVector.Builder(
            name = "PhidataColor",
            ...
            path(fill = SolidColor(Color(0xFFFF4017)), pathFillType = PathFillType.EvenOdd) {
