...
private var _ai360color: ImageVector? = null

val Lobicons.Ai360Color: ImageVector
    get() {
        if (_ai360color != null) return _ai360color!!
        _ai360color = ImageVector.Builder(
            name = "Ai360Color",
            ...
            path(fill = Brush.linearGradient(
                ...
                pathData("M13.83 7.961a.755.755 0 11-1.51 0 .755.755 0 011.51 0z")
            }
            path(fill = Brush.linearGradient(
                    0.0f to Color(0xFF006FFB), 1.0f to Color(0xFF12B7FA),
                    start = Offset(11.943f, 6.085f),
                ...
                pathData("M10.809 16.678a.755.755 0 100-1.511.755.755 0 000 1.51z")
            }
        }.build()
        return _ai360color!!
    }
