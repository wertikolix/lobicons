...
private var _baiducolor: ImageVector? = null

val Lobicons.BaiduColor: ImageVector
    get() {
        if (_baiducolor != null) return _baiducolor!!
        _baiducolor = ImageVector.Builder(
            name = "BaiduColor",
