...
private var _sophnetcolor: ImageVector? = null

val Lobicons.SophnetColor: ImageVector
    get() {
        if (_sophnetcolor != null) return _sophnetcolor!!
        _sophnetcolor = ImageVector.Builder(
            name = "SophnetColor",
            ...
            path(fill = SolidColor(Color(0xFF6200EE))) {
