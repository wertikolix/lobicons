...
private var _openclaw: ImageVector? = null

val Lobicons.Openclaw: ImageVector
    get() {
        if (_openclaw != null) return _openclaw!!
        _openclaw = ImageVector.Builder(
            name = "Openclaw",
