...
private var _kling: ImageVector? = null

val Lobicons.Kling: ImageVector
    get() {
        if (_kling != null) return _kling!!
        _kling = ImageVector.Builder(
            name = "Kling",
