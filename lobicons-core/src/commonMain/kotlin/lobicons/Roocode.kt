...
private var _roocode: ImageVector? = null

val Lobicons.Roocode: ImageVector
    get() {
        if (_roocode != null) return _roocode!!
        _roocode = ImageVector.Builder(
            name = "Roocode",
