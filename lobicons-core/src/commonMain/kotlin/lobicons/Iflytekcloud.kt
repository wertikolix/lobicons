...
private var _iflytekcloud: ImageVector? = null

val Lobicons.Iflytekcloud: ImageVector
    get() {
        if (_iflytekcloud != null) return _iflytekcloud!!
        _iflytekcloud = ImageVector.Builder(
            name = "Iflytekcloud",
