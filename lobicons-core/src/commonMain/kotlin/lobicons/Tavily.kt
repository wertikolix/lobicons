...
private var _tavily: ImageVector? = null

val Lobicons.Tavily: ImageVector
    get() {
        if (_tavily != null) return _tavily!!
        _tavily = ImageVector.Builder(
            name = "Tavily",
