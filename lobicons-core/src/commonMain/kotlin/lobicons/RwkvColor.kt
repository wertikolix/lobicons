...
private var _rwkvcolor: ImageVector? = null

val Lobicons.RwkvColor: ImageVector
    get() {
        if (_rwkvcolor != null) return _rwkvcolor!!
        _rwkvcolor = ImageVector.Builder(
            name = "RwkvColor",
