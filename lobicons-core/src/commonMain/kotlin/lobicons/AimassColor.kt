...
private var _aimasscolor: ImageVector? = null

val Lobicons.AimassColor: ImageVector
    get() {
        if (_aimasscolor != null) return _aimasscolor!!
        _aimasscolor = ImageVector.Builder(
            name = "AimassColor",
