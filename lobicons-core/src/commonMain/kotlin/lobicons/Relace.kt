...
private var _relace: ImageVector? = null

val Lobicons.Relace: ImageVector
    get() {
        if (_relace != null) return _relace!!
        _relace = ImageVector.Builder(
            name = "Relace",
