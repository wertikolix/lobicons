...
private var _zeroone: ImageVector? = null

val Lobicons.Zeroone: ImageVector
    get() {
        if (_zeroone != null) return _zeroone!!
        _zeroone = ImageVector.Builder(
            name = "Zeroone",
