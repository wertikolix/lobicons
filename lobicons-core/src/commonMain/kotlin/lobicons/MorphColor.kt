...
private var _morphcolor: ImageVector? = null

val Lobicons.MorphColor: ImageVector
    get() {
        if (_morphcolor != null) return _morphcolor!!
        _morphcolor = ImageVector.Builder(
            name = "MorphColor",
