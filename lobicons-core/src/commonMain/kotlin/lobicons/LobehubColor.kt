...
private var _lobehubcolor: ImageVector? = null

val Lobicons.LobehubColor: ImageVector
    get() {
        if (_lobehubcolor != null) return _lobehubcolor!!
        _lobehubcolor = ImageVector.Builder(
            name = "LobehubColor",
            defaultWidth = 320.0.dp,
            defaultHeight = 320.0.dp,
            viewportWidth = 320.0f,
            viewportHeight = 320.0f,
        ).apply {
            path(fill = SolidColor(Color.Black)) {
                pathData("M294 172.519c0 75.655-59.442 128.5-134 128.5-74.558 0-134-53.845-134-129.5 0-22.5 5-32.141 31.5-35.671 47.5-6.329 72.542-3.829 102.5-3.829 29.959 0 72.556-1.27 102.5 3.829 24.5 4.171 30 8.671 31.5 36.671z")
            }
            ...
            path(fill = SolidColor(Color.Black)) {
                pathData("M82.998 20.517a9.5 9.5 0 11-19 0 9.5 9.5 0 0119 0z")
            }
            path(fill = SolidColor(Color.Black)) {
                pathData("M71.002 108.021c0 8.836-7.163 16-16 16s-16-7.164-16-16c0-8.837 7.163-16 16-16s16 7.163 16 16z")
            }
            path(fill = SolidColor(Color.Black)) {
                pathData("M282.002 49.516c0 8.56-6.94 15.5-15.5 15.5-8.56 0-15.5-6.94-15.5-15.5 0-8.56 6.94-15.5 15.5-15.5 8.56 0 15.5 6.94 15.5 15.5z")
            }
            path(fill = SolidColor(Color(0xFFFFFFFF))) {
                pathData("M132.232 244.111c5.483-.823 14.191-1.601 27.515-1.601 12.212 0 20.546.654 26.073 1.396-1.542 5.861-12.963 8.104-26.823 8.104-13.698 0-25.013-2.191-26.765-7.899z")
            }
            path(fill = SolidColor(Color.Black)) {
                pathData("M160.006 290.016c20.099 0 23.305-20.488 23.927-25.61.478-4.146-1.675-6.244-4.02-7.659-2.345-1.414-9.379-2.731-19.907-2.731-10.527 0-17.514 1.317-19.906 2.731-2.393 1.415-4.546 3.513-4.02 7.659.622 5.122 3.828 25.61 23.926 25.61z")
            }
            path(fill = SolidColor(Color.Black)) {
                pathData("M171.694 129.744c-5.721-3.89-13.954-4.248-19.786-.526-7.724 4.929-16.971 7.798-26.91 7.798-27.062 0-49-21.267-49-47.5 0-26.234 21.938-47.5 49-47.5 13.628 0 25.956 5.392 34.838 14.097 4.948 4.85 13.088 6.24 19.498 3.609a42.502 42.502 0 0116.164-3.166c22.92 0 41.5 18.012 41.5 40.23 0 22.218-18.58 40.23-41.5 40.23-8.856 0-17.065-2.69-23.804-7.272z")
            }
            path(fill = SolidColor(Color.Black)) {
                pathData("M219.002 106.51c0 7.456-6.044 13.5-13.5 13.5s-13.5-6.044-13.5-13.5 6.044-13.5 13.5-13.5 13.5 6.044 13.5 13.5z")
            }
        }.build()
        return _lobehubcolor!!
    }
