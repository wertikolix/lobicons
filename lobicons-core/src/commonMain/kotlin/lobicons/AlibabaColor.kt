...
private var _alibabacolor: ImageVector? = null

val Lobicons.AlibabaColor: ImageVector
    get() {
        if (_alibabacolor != null) return _alibabacolor!!
        _alibabacolor = ImageVector.Builder(
            name = "AlibabaColor",
