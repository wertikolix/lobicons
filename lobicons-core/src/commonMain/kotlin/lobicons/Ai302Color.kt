...
private var _ai302color: ImageVector? = null

val Lobicons.Ai302Color: ImageVector
    get() {
        if (_ai302color != null) return _ai302color!!
        _ai302color = ImageVector.Builder(
            name = "Ai302Color",
