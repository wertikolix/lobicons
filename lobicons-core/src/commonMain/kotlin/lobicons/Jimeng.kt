...
private var _jimeng: ImageVector? = null

val Lobicons.Jimeng: ImageVector
    get() {
        if (_jimeng != null) return _jimeng!!
        _jimeng = ImageVector.Builder(
            name = "Jimeng",
