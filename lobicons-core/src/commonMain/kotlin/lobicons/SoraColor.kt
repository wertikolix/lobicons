...
private var _soracolor: ImageVector? = null

val Lobicons.SoraColor: ImageVector
    get() {
        if (_soracolor != null) return _soracolor!!
        _soracolor = ImageVector.Builder(
            name = "SoraColor",
            ...
            path(fill = Brush.linearGradient(
                    0.0f to Color(0xFF012659), 1.0f to Color(0xFF0968DA),
            ...
            path(fill = Brush.linearGradient(
                    0.0f to Color(0xFFFFFFFF), 1.0f to Color(0xFF6BB6FE),
                    start = Offset(9.859f, 3.0f),
                    end = Offset(14.219f, 21.017f),
                )) {
                pathData("M9.726 11.36a.306.306 0 110 .612.306.306 0 010-.612z")
            }
            path(fill = Brush.linearGradient(
                    0.0f to Color(0xFFFFFFFF), 1.0f to Color(0xFF6BB6FE),
                    start = Offset(9.859f, 3.0f),
                ...
                pathData("M8.408 9.561c.033-.009.065.002.096.033.145.15.292.298.44.447l.021.016c.01.005.017.009.024.01l.608.157c.042.01.068.033.077.066.009.035-.002.067-.033.098l-.447.439a.098.098 0 00-.016.022.1.1 0 00-.01.024l-.157.607c-.01.042-.033.068-.067.077-.034.01-.066-.002-.096-.033l-.44-.446a.117.117 0 00-.047-.027c-.202-.053-.405-.105-.607-.156-.042-.01-.068-.033-.077-.068-.01-.033.002-.066.033-.096.15-.146.298-.292.447-.44a.092.092 0 00.016-.021.101.101 0 00.01-.025l.157-.607c.01-.042.033-.068.068-.077z")
            }
            path(fill = Brush.linearGradient(
                    0.0f to Color(0xFFFFFFFF), 1.0f to Color(0xFF6BB6FE),
                    start = Offset(9.859f, 3.0f),
                ...
                pathData("M14.87 9.982a.307.307 0 110 .613.307.307 0 010-.613z")
            }
            path(fill = Brush.linearGradient(
                    0.0f to Color(0xFFFFFFFF), 1.0f to Color(0xFF6BB6FE),
                    start = Offset(9.859f, 3.0f),
