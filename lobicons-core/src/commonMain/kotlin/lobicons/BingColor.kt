...
private var _bingcolor: ImageVector? = null

val Lobicons.BingColor: ImageVector
    get() {
        if (_bingcolor != null) return _bingcolor!!
        _bingcolor = ImageVector.Builder(
            name = "BingColor",
