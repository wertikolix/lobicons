...
private var _elevenx: ImageVector? = null

val Lobicons.Elevenx: ImageVector
    get() {
        if (_elevenx != null) return _elevenx!!
        _elevenx = ImageVector.Builder(
            name = "Elevenx",
