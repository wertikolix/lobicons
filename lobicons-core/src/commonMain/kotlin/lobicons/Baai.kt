...
private var _baai: ImageVector? = null

val Lobicons.Baai: ImageVector
    get() {
        if (_baai != null) return _baai!!
        _baai = ImageVector.Builder(
            name = "Baai",
