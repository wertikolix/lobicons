...
private var _metagpt: ImageVector? = null

val Lobicons.Metagpt: ImageVector
    get() {
        if (_metagpt != null) return _metagpt!!
        _metagpt = ImageVector.Builder(
            name = "Metagpt",
