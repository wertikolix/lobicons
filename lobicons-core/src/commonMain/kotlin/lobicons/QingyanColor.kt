...
private var _qingyancolor: ImageVector? = null

val Lobicons.QingyanColor: ImageVector
    get() {
        if (_qingyancolor != null) return _qingyancolor!!
        _qingyancolor = ImageVector.Builder(
            name = "QingyanColor",
