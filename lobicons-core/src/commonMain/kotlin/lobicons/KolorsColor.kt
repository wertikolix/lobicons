...
private var _kolorscolor: ImageVector? = null

val Lobicons.KolorsColor: ImageVector
    get() {
        if (_kolorscolor != null) return _kolorscolor!!
        _kolorscolor = ImageVector.Builder(
            name = "KolorsColor",
