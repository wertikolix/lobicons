...
private var _phind: ImageVector? = null

val Lobicons.Phind: ImageVector
    get() {
        if (_phind != null) return _phind!!
        _phind = ImageVector.Builder(
            name = "Phind",
