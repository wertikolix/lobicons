...
val Lobicons.Fishaudio: ImageVector
    get() {
        if (_fishaudio != null) return _fishaudio!!
        _fishaudio = ImageVector.Builder(
            name = "Fishaudio",
