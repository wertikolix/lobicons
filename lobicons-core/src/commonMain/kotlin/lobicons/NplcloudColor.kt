...
private var _nplcloudcolor: ImageVector? = null

val Lobicons.NplcloudColor: ImageVector
    get() {
        if (_nplcloudcolor != null) return _nplcloudcolor!!
        _nplcloudcolor = ImageVector.Builder(
            name = "NplcloudColor",
            ...
            path(fill = SolidColor(Color(0xFF00D1B2))) {
