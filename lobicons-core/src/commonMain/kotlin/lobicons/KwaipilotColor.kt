    ...
    get() {
        ...
        _kwaipilotcolor = ImageVector.Builder(
            ...
            path(fill = Brush.linearGradient(
                    0.313f to Color(0xFF9EC0E0), 1.0f to Color(0xFFFFFFFF),
                    start = Offset(13.469f, 4.823f),
                    end = Offset(12.557f, 21.302f),
                )) {
            ...
            path(fill = Brush.linearGradient(
                    0.0f to Color(0xFFFFFFFF), 1.0f to Color(0xFFBCD5EC),
                    start = Offset(13.739f, 4.229f),
                    end = Offset(5.647f, 17.386f),
                )) {
