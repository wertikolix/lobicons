...
private var _cerebrascolor: ImageVector? = null

val Lobicons.CerebrasColor: ImageVector
    get() {
        if (_cerebrascolor != null) return _cerebrascolor!!
        _cerebrascolor = ImageVector.Builder(
            name = "CerebrasColor",
            ...
            path(fill = SolidColor(Color(0xFFF15A29)), pathFillType = PathFillType.EvenOdd) {
