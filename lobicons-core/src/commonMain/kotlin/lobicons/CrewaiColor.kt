...
private var _crewaicolor: ImageVector? = null

val Lobicons.CrewaiColor: ImageVector
    get() {
        if (_crewaicolor != null) return _crewaicolor!!
        _crewaicolor = ImageVector.Builder(
            name = "CrewaiColor",
