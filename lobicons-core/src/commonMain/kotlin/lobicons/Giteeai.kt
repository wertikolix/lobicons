...
private var _giteeai: ImageVector? = null

val Lobicons.Giteeai: ImageVector
    get() {
        if (_giteeai != null) return _giteeai!!
        _giteeai = ImageVector.Builder(
            name = "Giteeai",
