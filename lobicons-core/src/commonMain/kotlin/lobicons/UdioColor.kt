...
private var _udiocolor: ImageVector? = null

val Lobicons.UdioColor: ImageVector
    get() {
        if (_udiocolor != null) return _udiocolor!!
        _udiocolor = ImageVector.Builder(
            name = "UdioColor",
