...
private var _ppiocolor: ImageVector? = null

val Lobicons.PpioColor: ImageVector
    get() {
        if (_ppiocolor != null) return _ppiocolor!!
        _ppiocolor = ImageVector.Builder(
            name = "PpioColor",
