...
private var _deepcogitocolor: ImageVector? = null

val Lobicons.DeepcogitoColor: ImageVector
    get() {
        if (_deepcogitocolor != null) return _deepcogitocolor!!
        _deepcogitocolor = ImageVector.Builder(
            name = "DeepcogitoColor",
            defaultWidth = 24.0.dp,
            defaultHeight = 24.0.dp,
            viewportWidth = 24.0f,
            viewportHeight = 24.0f,
        ).apply {
            path(fill = SolidColor(Color(0xFF4E81EE))) {
