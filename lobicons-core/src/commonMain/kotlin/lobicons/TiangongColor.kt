...
private var _tiangongcolor: ImageVector? = null

val Lobicons.TiangongColor: ImageVector
    get() {
        if (_tiangongcolor != null) return _tiangongcolor!!
        _tiangongcolor = ImageVector.Builder(
            name = "TiangongColor",
            ...
            path(fill = Brush.linearGradient(
                ...
                pathData("M.647 5.203h6.31c2.445 0 4.434 1.967 4.432 4.38v4.838c0 3.06 2.524 5.552 5.628 5.552h6.31a.592.592 0 00.597-.586.59.59 0 00-.596-.589h-6.323a4.428 4.428 0 01-4.094-2.7 4.325 4.325 0 01-.335-1.68V9.584c0-3.055-2.52-5.549-5.618-5.555H.647a.592.592 0 00-.594.589.592.592 0 00.594.586z")
            }
            path(fill = Brush.linearGradient(
                    0.0f to Color(0xFF6865FC), 1.0f to Color(0xFF467DF9),
                    start = Offset(0.0f, 11.5f),
