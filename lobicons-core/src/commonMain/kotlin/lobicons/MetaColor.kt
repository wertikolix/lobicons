...
val Lobicons.MetaColor: ImageVector
    get() {
        ...
        _metacolor = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFF0867DF))) {
            ...
            path(fill = SolidColor(Color(0xFF0064DF))) {
            ...
            path(fill = SolidColor(Color(0xFF0072EC))) {
            ...
            path(fill = SolidColor(Color(0xFF007FF8))) {
            ...
            path(fill = SolidColor(Color(0xFF0081FA))) {
            ...
            path(fill = SolidColor(Color(0xFF027AF3))) {
            ...
            path(fill = SolidColor(Color(0xFF0377EF))) {
            ...
            path(fill = SolidColor(Color(0xFF0471E9))) {
