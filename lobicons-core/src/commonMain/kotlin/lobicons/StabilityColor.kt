...
private var _stabilitycolor: ImageVector? = null

val Lobicons.StabilityColor: ImageVector
    get() {
        if (_stabilitycolor != null) return _stabilitycolor!!
        _stabilitycolor = ImageVector.Builder(
            name = "StabilityColor",
