...
private var _doc2xcolor: ImageVector? = null

val Lobicons.Doc2xColor: ImageVector
    get() {
        if (_doc2xcolor != null) return _doc2xcolor!!
        _doc2xcolor = ImageVector.Builder(
            name = "Doc2xColor",
            ...
            path(fill = SolidColor(Color(0xFF7748F9))) {
            ...
            path(fill = SolidColor(Color(0xFFBFABFB))) {
