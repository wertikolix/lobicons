...
private var _targon: ImageVector? = null

val Lobicons.Targon: ImageVector
    get() {
        if (_targon != null) return _targon!!
        _targon = ImageVector.Builder(
            name = "Targon",
