...
private var _goose: ImageVector? = null

val Lobicons.Goose: ImageVector
    get() {
        if (_goose != null) return _goose!!
        _goose = ImageVector.Builder(
            name = "Goose",
