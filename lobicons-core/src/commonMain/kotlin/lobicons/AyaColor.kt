...
private var _ayacolor: ImageVector? = null

val Lobicons.AyaColor: ImageVector
    get() {
        if (_ayacolor != null) return _ayacolor!!
        _ayacolor = ImageVector.Builder(
            name = "AyaColor",
