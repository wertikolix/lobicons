...
private var _falcolor: ImageVector? = null

val Lobicons.FalColor: ImageVector
    get() {
        if (_falcolor != null) return _falcolor!!
        _falcolor = ImageVector.Builder(
            name = "FalColor",
