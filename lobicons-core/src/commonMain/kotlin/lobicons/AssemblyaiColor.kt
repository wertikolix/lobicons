...
private var _assemblyaicolor: ImageVector? = null

val Lobicons.AssemblyaiColor: ImageVector
    get() {
        if (_assemblyaicolor != null) return _assemblyaicolor!!
        _assemblyaicolor = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFF2545D3))) {
            ...
            path(fill = SolidColor(Color(0xFF566DE8))) {
