...
private var _cogviewcolor: ImageVector? = null

val Lobicons.CogviewColor: ImageVector
    get() {
        if (_cogviewcolor != null) return _cogviewcolor!!
        _cogviewcolor = ImageVector.Builder(
            name = "CogviewColor",
            ...
            path(fill = SolidColor(Color(0xFFE8096A))) {
            ...
            path(fill = SolidColor(Color(0xFF412DF5))) {
            ...
            path(fill = SolidColor(Color(0xFFE60030))) {
            ...
            path(fill = SolidColor(Color(0xFFFF6500))) {
            ...
            path(fill = SolidColor(Color(0xFFEA4D07))) {
            ...
            path(fill = SolidColor(Color(0xFF0091FF))) {
            ...
            path(fill = SolidColor(Color(0xFFDE003B))) {
            ...
            path(fill = SolidColor(Color(0xFFFF8E00))) {
            ...
            path(fill = SolidColor(Color(0xFFFFB41F))) {
            ...
            path(fill = SolidColor(Color(0xFF008DFF))) {
