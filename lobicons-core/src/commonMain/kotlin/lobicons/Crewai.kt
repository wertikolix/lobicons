...
val Lobicons.Crewai: ImageVector
    get() {
        if (_crewai != null) return _crewai!!
        _crewai = ImageVector.Builder(
            name = "Crewai",
