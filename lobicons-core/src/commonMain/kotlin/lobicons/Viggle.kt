...
private var _viggle: ImageVector? = null

val Lobicons.Viggle: ImageVector
    get() {
        if (_viggle != null) return _viggle!!
        _viggle = ImageVector.Builder(
            name = "Viggle",
