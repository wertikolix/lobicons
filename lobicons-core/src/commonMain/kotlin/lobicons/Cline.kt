...
val Lobicons.Cline: ImageVector
    get() {
        if (_cline != null) return _cline!!
        _cline = ImageVector.Builder(
            name = "Cline",
