...
private var _hailuocolor: ImageVector? = null

val Lobicons.HailuoColor: ImageVector
    get() {
        if (_hailuocolor != null) return _hailuocolor!!
        _hailuocolor = ImageVector.Builder(
            name = "HailuoColor",
