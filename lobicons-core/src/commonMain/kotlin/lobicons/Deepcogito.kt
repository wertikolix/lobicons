...
private var _deepcogito: ImageVector? = null

val Lobicons.Deepcogito: ImageVector
    get() {
        if (_deepcogito != null) return _deepcogito!!
        _deepcogito = ImageVector.Builder(
            name = "Deepcogito",
