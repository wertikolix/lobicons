...
private var _krea: ImageVector? = null

val Lobicons.Krea: ImageVector
    get() {
        if (_krea != null) return _krea!!
        _krea = ImageVector.Builder(
            name = "Krea",
