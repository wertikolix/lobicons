...
private var _greptilecolor: ImageVector? = null

val Lobicons.GreptileColor: ImageVector
    get() {
        if (_greptilecolor != null) return _greptilecolor!!
        _greptilecolor = ImageVector.Builder(
            name = "GreptileColor",
