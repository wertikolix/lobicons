...
private var _player2color: ImageVector? = null

val Lobicons.Player2Color: ImageVector
    get() {
        if (_player2color != null) return _player2color!!
        _player2color = ImageVector.Builder(
            name = "Player2Color",
