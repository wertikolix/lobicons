...
private var _sora: ImageVector? = null

val Lobicons.Sora: ImageVector
    get() {
        if (_sora != null) return _sora!!
        _sora = ImageVector.Builder(
            name = "Sora",
