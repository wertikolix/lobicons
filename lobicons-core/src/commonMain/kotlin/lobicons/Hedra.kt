...
private var _hedra: ImageVector? = null

val Lobicons.Hedra: ImageVector
    get() {
        if (_hedra != null) return _hedra!!
        _hedra = ImageVector.Builder(
            name = "Hedra",
