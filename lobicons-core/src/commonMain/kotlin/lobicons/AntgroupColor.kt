...
private var _antgroupcolor: ImageVector? = null

val Lobicons.AntgroupColor: ImageVector
    get() {
        if (_antgroupcolor != null) return _antgroupcolor!!
        _antgroupcolor = ImageVector.Builder(
            name = "AntgroupColor",
