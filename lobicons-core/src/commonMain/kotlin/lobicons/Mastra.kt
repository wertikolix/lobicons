...
private var _mastra: ImageVector? = null

val Lobicons.Mastra: ImageVector
    get() {
        if (_mastra != null) return _mastra!!
        _mastra = ImageVector.Builder(
            name = "Mastra",
